...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
        List<Question> allQuestion= questionMap.entrySet().stream().map(Map.Entry::getValue).collect(Collectors.toList());
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        List<Question> allQuestionLevel= questionMap.entrySet().stream().filter(e->e.getValue().getLevel().equals(level)).
