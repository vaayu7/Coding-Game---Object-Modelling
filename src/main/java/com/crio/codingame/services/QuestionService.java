...
public class QuestionService implements IQuestionService{
    ...
    public List<Question> getAllQuestionLevelWise(Level level) {
       // List<Question> AllQuest = new ArrayList<Question>();
        List<Question> AllQuestLevel = new ArrayList<Question>();
        //AllQuest= questionRepository.findAll();
        if(level==null){
            AllQuestLevel = questionRepository.findAll();
        }
        
        else{
            AllQuestLevel=questionRepository.findAllQuestionLevelWise(level);
        }
        
      return AllQuestLevel;
