...
public class WithdrawContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        try{
            UserRegistrationDto withdrwContest = userService.withdrawContest(tokens.get(1), tokens.get(2));
            System.out.println(withdrwContest);
        }
        catch(ContestNotFoundException contestNotFoundException){
            System.out.println(contestNotFoundException.getMessage());
        }
