...
public class LeaderBoardCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        ...
        List<User> getAllUserdScoreOrderWise = new ArrayList<>();
        getAllUserdScoreOrderWise= userService.getAllUserScoreOrderWise(scoreOrder);
        System.out.println(getAllUserdScoreOrderWise);
    }
